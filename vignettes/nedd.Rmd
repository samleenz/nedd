...
The price collecitn gsteiner forest algorithm allows the joint analysis of node and edge weights to find optimal subgraphs under a single objective function. The `PCSF` package implements this in R and the package documentation does a good job of describing the method.
